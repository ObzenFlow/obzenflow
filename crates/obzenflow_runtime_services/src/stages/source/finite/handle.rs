...
pub type FiniteSourceHandle<H = Box<dyn FiniteSourceHandler>> = StandardHandle<FiniteSourceEvent<H>, FiniteSourceState<H>>;
...
impl<H: FiniteSourceHandler + Send + Sync + 'static> FiniteSourceHandleExt<H> for FiniteSourceHandle<H> {
