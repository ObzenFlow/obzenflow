...
pub type InfiniteSourceHandle<H = Box<dyn InfiniteSourceHandler>> = StandardHandle<InfiniteSourceEvent<H>, InfiniteSourceState<H>>;
...
impl<H: InfiniteSourceHandler + Send + Sync + 'static> InfiniteSourceHandleExt<H> for InfiniteSourceHandle<H> {
