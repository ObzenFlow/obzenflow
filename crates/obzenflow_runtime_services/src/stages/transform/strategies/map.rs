...
//!
//! ```ignore
//! use obzenflow_runtime_services::stages::transform::strategies::MapTyped;
...
//!
//! ```ignore
//! use obzenflow_runtime_services::stages::transform::strategies::Map;
//!
    ...
    F: Fn(ChainEvent) -> ChainEvent + Send + Sync + Clone,
{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("Map").field("mapper", &"<closure>").finish()
    }
}
