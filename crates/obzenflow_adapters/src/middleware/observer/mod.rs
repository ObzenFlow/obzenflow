...
use crate::middleware::{
    CheckedMiddlewareSurfaceAttachment, MiddlewareSurfaceAttachmentKind, MiddlewareSurfaceKind,
};
    ...
    (
        ...
        impl StageObserverSet {
            ...
            pub fn push_attachment(
                ...
                match attachment.into_kind() {
                    $(
                        MiddlewareSurfaceAttachmentKind::$attach(observer) => self.$field.push(observer),
                    )+
                    $( MiddlewareSurfaceAttachmentKind::$control(_) )|+ => {
                        return Err(
...
mod tests {
    ...
    fn push_attachment_routes_observer_to_its_surface() {
        let observer = CountingHandlerObserver::new(ObserverDeterminism::Deterministic);
        let mut set = StageObserverSet::default();
        let raw = crate::middleware::MiddlewareSurfaceAttachment::handler_observer(observer);
        set.push_attachment(CheckedMiddlewareSurfaceAttachment::from_validated(raw))
