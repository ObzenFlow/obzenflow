...
async fn run_4_stage_pipeline() -> anyhow::Result<Duration> {
    ...
    let flow_definition = FlowDefinition::materialize(move |_runtime_config| {
        ...
        let third_passthrough = PassthroughStage::new("stage3");
        ...
        Ok(flow! {
            ...
            stages: {
                ...
                s3 = transform!(BenchEvent -> BenchEvent => third_passthrough);
