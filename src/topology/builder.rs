use crate::topology::{StageId, StageInfo, DirectedEdge, PipelineTopology, TopologyError};
...
impl PipelineBuilder {
    ...
    /// Build the topology
    pub fn build(self) -> Result<PipelineTopology, TopologyError> {
        PipelineTopology::new(self.stages, self.edges)
    }
}
